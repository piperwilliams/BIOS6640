...
In the year 2016, there were approximately 216 million reported cases of malaria  and 450,000 malaria-related deaths worldwide.$^1$ In the same year, 91% of all malaria-related deaths were concentrated in the World Health Organization (WHO) African region, which includes the country of Mozambique.$^1$ $\vspace{0.25cm}$
